                ...
                <div className="nk-content-body">
                    <div className="nk-block-head nk-block-head-sm">
                        <div className="nk-block-between g-3">
                            ...
                            <div className="nk-block-head-content"><a href="customer-list.html"
                                className="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em
                                    className="icon ni ni-arrow-left"></em><span>Back</span></a><a
                                        href="customer-list.html"
                                        className="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em
                                            className="icon ni ni-arrow-left"></em></a></div>
                        </div>
                    </div>
                                    ...
                                    <div className="card-inner-group">
                                        <div className="card-inner">
                                            <div className="user-card user-card-s2">
                                                <div className="user-avatar lg bg-primary"><img
                                                    src="src/assets/images/avatar/b-sm.jpg" alt="" /></div>
                                                <div className="user-info">
                                                    <div className="badge bg-light rounded-pill ucap">Platinam</div>
                                                    <h5>Francis Mitcham</h5><span
                                                        className="sub-text">info@softnio.com</span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="col">
                                                    <div className="profile-stats"><span
                                                        className="amount">23</span><span
                                                            className="sub-text">Orders</span></div>
                                                </div>
                                                <div className="col">
                                                    <div className="profile-stats"><span
                                                        className="amount">20</span><span
                                                            className="sub-text">Completed</span></div>
                                                </div>
                                                <div className="col">
                                                    <div className="profile-stats"><span
                                        ...
                                        <div className="card-inner">
                                            ...
                                            <div className="row g-3">
                                                <div className="col-sm-6 col-md-4 col-xl-12"><span
                                                    className="sub-text">User ID:</span><span>UD003054</span>
                                                </div>
                                                <div className="col-sm-6 col-md-4 col-xl-12"><span
                                                    className="sub-text">Billing
                                                    Email:</span><span>billing@softnio.com</span></div>
                                                <div className="col-sm-6 col-md-4 col-xl-12"><span
                                                    className="sub-text">Billing Address:</span><span>551
                                                ...
                                                <div className="col-sm-6 col-md-4 col-xl-12"><span
                                                    className="sub-text">Language:</span><span>English,
                                                        France</span></div>
                                                <div className="col-sm-6 col-md-4 col-xl-12"><span
                                                    className="sub-text">Last Login:</span><span>15 Feb, 2019
                                                        01:02 PM</span></div>
                                                <div className="col-sm-6 col-md-4 col-xl-12"><span
                                    ...
                                    <div className="card-inner">
                                        ...
                                        <div className="nk-block">
                                            ...
                                            <div className="nk-tb-list nk-tb-ulist is-compact card">
                                                ...
                                                <div className="nk-tb-item">
                                                    ...
                                                    <div className="nk-tb-col tb-col-sm"><span
                                                        className="tb-product"><img src="images/product/c.png"
                                                            alt="" className="thumb" /><span className="title">Black
                                                                Mi Band Smartwatch</span></span></div>
                                                    <div className="nk-tb-col tb-col-xxl"><span className="amount">$
                                                        89.49</span></div>
                                                    <div className="nk-tb-col"><span
                                                        className="lead-text text-warning">Shipped</span></div>
                                                ...
                                                <div className="nk-tb-item">
                                                    ...
                                                    <div className="nk-tb-col tb-col-sm"><span
                                                        className="tb-product"><img src="images/product/b.png"
                                                            alt="" className="thumb" /><span className="title">Purple
                                                ...
                                                <div className="nk-tb-item">
                                                    ...
                                                    <div className="nk-tb-col tb-col-sm"><span
                                                        className="tb-product"><img src="images/product/a.png"
                                                            alt="" className="thumb" /><span className="title">Pink
                                                                Fitness Tracker</span></span></div>
                                                    <div className="nk-tb-col tb-col-xxl"><span
                                                        className="amount">$99.49</span></div>
                                                    <div className="nk-tb-col"><span
                                                        className="lead-text text-danger">Canceled</span></div>
                                                    <div className="nk-tb-col"><span className="sub-text">Never</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="nk-block">
                                            ...
                                            <div className="row g-3">
                                                        ...
                                                        <div className="card-inner">
                                                            <div
                                                                ...
                                                                <div className="d-flex align-items-center">
                                                                    <div className="icon-circle icon-circle-lg"><em
                                                                        className="icon ni ni-visa"></em></div>
                                                                    <div className="ms-3">
                                                                        <h6 className="lead-text">Visa Card <span
                                                        ...
                                                        <div className="card-inner">
                                                            <div
                                                                ...
                                                                <div className="d-flex align-items-center">
                                                                    ...
                                                                    <div className="ms-3">
                                                                        <h6 className="lead-text">American Express
                                                            ...
                                                            <div
                                                                ...
                                                                <div className="d-flex align-items-center">
                                                                    <div
                                                                        ...
                                                                        <em className="icon ni ni-mc"></em></div>
                                                                    <div className="ms-3">
                                                                        <h6 className="lead-text">Mastercard <span
                                                                            className="text-soft ml-1">****
                                                                            9478</span></h6><span
                                                ...
                                                <div className="col-12 col-lg-6 col-xl-12"><button
                                                    className="h-100 w-100 bg-white border border-dashed round-xl p-4 d-flex align-items-center justify-content-center"
                                                    data-bs-toggle="modal" data-bs-target="#add-card"><span
                                                        className="text-soft">Add New Card</span></button></div>
                                            </div>
                                        </div>
                                        <div className="nk-block">
                                            ...
                                            <div className="card">
                                                <div className="card-inner">
                                                    <div className="between-center flex-wrap flex-md-nowrap g-3">
                                                        ...
                                                        <div className="nk-block-actions flex-shrink-0"><a href="#"
                                                            className="btn btn-lg btn-danger">Revoke Access</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div className="media media-center gx-3 wide-xs">
                                                            ...
                                                            <div className="media-content">
                                                                <p>You can connect with your google account. <em
                                                                    className="d-block text-soft">Not connected
                                                                    yet</em></p>
                                                            </div>
                                                        </div>
                                                        <div className="nk-block-actions flex-shrink-0"><a href="#"
